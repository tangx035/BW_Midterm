...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Midterm_Bottles.data';
    var REMOTE_PACKAGE_BASE = 'Midterm_Bottles.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2853446;
      var PACKAGE_UUID = 'f524a461-bcd3-46cb-8813-16639b421d68';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 478594, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(478594, 478613, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(478613, 479017, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(479017, 1950849, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1950849, 2825821, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2825821, 2853446, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Midterm_Bottles.data');

    };
    Module['addRunDependency']('datafile_Midterm_Bottles.data');
